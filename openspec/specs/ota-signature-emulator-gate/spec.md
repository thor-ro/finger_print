# OTA Signature Emulator Gate

## Purpose
Specifies the hardware-free CI gate running under esp-emu to verify that OTA signature verification is active, rejecting tampered and foreign-signed images while committing validly signed images.
