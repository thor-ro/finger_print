# BLE OTA Emulator Harness

## Purpose
Specifies the scriptable GATT central test harness for driving companion BLE OTA updates against an emulated ESP32-C6 target without hardware.
