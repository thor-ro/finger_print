# Spec: web-companion-theming

## Purpose

This specification covers theme styling, token contracts, theme selection, persistence, and theme validation gates for the Web Companion.
