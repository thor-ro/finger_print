# Spec: companion-identity

## Purpose
This specification covers identity and account management for the BLE Companion Service, unifying companion accounts as attributes of enrolled fingerprint users rather than an independent account namespace.
