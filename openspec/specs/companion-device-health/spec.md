# Spec: companion-device-health

## Purpose
This specification covers the transport-independent device health reporting system, defining the state cache, health report producer, field vocabulary (measured / unknown / not applicable), and no-I/O constraints for querying health on the Smart Door Bridge.
