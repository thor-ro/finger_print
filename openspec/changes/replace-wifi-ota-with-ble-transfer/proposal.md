...
- Estimated flash savings: ~500 KB (to be confirmed exactly via `idf_size.py --archives` diff once the WiFi/TLS dependencies are actually removed from the link).
