...
static sdf_enrollment_result_t sdf_enrollment_result_from_driver(sdf_fingerprint_op_result_t result)
{
    switch (result) {
...
esp_err_t sdf_enrollment_sm_start(sdf_enrollment_sm_t *sm, uint16_t user_id, uint8_t permission)
{
    if (sm == NULL) {
